...
mlp = MLPClassifier(hidden_layer_sizes=(128,64),activation='relu',max_iter=500,verbose=False)

# Tao list file hinh training
# Get list of training and test images
print("Loading data for training")
from pathlib import Path
img_folder = Path('Case_3/dataset/MNIST')  # GenderDataset
...
# print(train_images[3].parent.name) # lay ten folder
# print(train_images[3].stem)        # lay ten file
